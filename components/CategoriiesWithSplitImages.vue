...
<template>
  ...
  <div class="min-h-full grid grid-rows-2 grid-cols-1 lg:grid-rows-1 lg:grid-cols-2">
    <div class="relative flex">
      <img src="https://tailwindui.com/img/ecommerce-images/home-page-02-edition-01.jpg" alt="ژورنال های ترک" class="absolute inset-0 w-full h-full object-center object-cover" />
