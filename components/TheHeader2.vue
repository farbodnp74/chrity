...
<!--      <Dialog as="div" class="inset-0 flex z-40 lg:hidden" @close="open = false">-->
...
<!--                    <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=indigo&shade=600" alt="ایرانی مارکت خریدی راحت از ترکیه" />-->
<!--                  </a>-->
<!--                </div>-->
...
<!--                  <span class="sr-only">Workflow</span>-->
<!--                  <img src="https://tailwindui.com/img/logos/workflow-mark.svg?color=indigo&shade=600" alt="ایرانی مارکت" class="h-8 w-auto" />-->
<!--                </a>-->
