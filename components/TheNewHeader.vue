...
<!--              </TabPanels>-->
<!--            </TabGroup>-->
            <router-link  to="/shop" class="m-2 p-2 block font-medium text-gray-900">
              محصولات
            </router-link>

            <router-link  to="/gallery" class="m-2 p-2 block font-medium text-gray-900">
              گالری
            </router-link>
...
<!--                          </router-link>-->
                  ...
                  <div class="flex items-center lg:ml-8">
                    <!-- login -->
                    <router-link target="_blank" to="/help"  class="text-sm font-extrabold bg-cyan-500 rounded-lg text-gray-50 mx-1 lg:mx-3 p-2 lg:font-extrabold lg:text-xl">
                        کمک به خیریه
                    </router-link>
