...
<template>
  <main class="relative lg:min-h-full">
    <div class="h-80 overflow-hidden lg:absolute lg:w-1/2 lg:h-full lg:pr-4 xl:pr-12">
      <img src="https://tailwindui.com/img/ecommerce-images/confirmation-page-06-hero.jpg" alt="ایرانی مارکت" class="h-full w-full object-center object-cover" />
    </div>
      ...
      <div class="max-w-2xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32 lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
        <div class="lg:col-start-2">
          ...
          <div class="mt-16 border-t border-gray-200 py-6 text-right">
            <router-link to="/" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">بازگشت به خانه<span aria-hidden="true"> &rarr;</span></router-link>
          </div>
        </div>
      </div>
    </div>
...
const products = [
  {
    ...
    size: 'L',
    imageSrc: '',
    imageAlt: "خرید شال و روسری خاص ترک با ایرانی مارکت",
  },
